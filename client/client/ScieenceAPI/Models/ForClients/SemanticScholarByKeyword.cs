...
{
    public class SemanticScholarByKeyword
    {
        public List<DataK> data { get; set; }
        public SemanticScholarByKeyword()
        {
            data = new List<DataK>();
        }
    }
    public class TotalSSK
    {
        public List<SemanticScholarByKeyword> totalContent { get; set; }
    }
    public class DataK
    {
